...
# ML = ML_TF(obs_ind = Norm1(inp_GPtrain,inp_GPtrain,Ndim), obs = Norm3(y_GPtrain,y_GPtrain))
# amp1, len1, var1 = ML.GP_train(amp_init=1.0, len_init=1.0, var_init=1.0, num_iters = 10000)
# Iters = 300
...
y_GPtrain = LS1.Scalar_Borehole_HF_nD(inp_GPtrain)
ML = ML_TF(obs_ind = Norm1(inp_GPtrain,inp_GPtrain,Ndim), obs = Norm3(y_GPtrain,y_GPtrain))
amp1, len1, var1 = ML.GP_train(amp_init=1.0, len_init=1.0, var_init=0.0001, num_iters = 10000)
Iters = 300
