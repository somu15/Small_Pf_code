...
class MaterialModel:
    ...
    def HF(self, Ex, Ez, vxy, vxz, Gxz, ux, uy, uz):
        ...
        os.system('mpiexec -n 3 /home/dhullaks/projects/moose/modules/tensor_mechanics/tensor_mechanics-opt -i Cylinder_HF_R5.i')

        path1 = '/home/dhullaks/projects/moose/modules/tensor_mechanics/test/tests/0_Cylinder/Cylinder_HF_R5.csv'
    ...
    def HF1(self, Ex, Ez, vxy, vxz, Gxz, ux, uy, uz):
        ...
        os.chdir('/home/dhullaks/projects/moose/modules/tensor_mechanics/test/tests/0_Cylinder')
        os.system('mpiexec -n 3 /home/dhullaks/projects/moose/modules/tensor_mechanics/tensor_mechanics-opt -i Cylinder_HF1_R5.i')

        path1 = '/home/dhullaks/projects/moose/modules/tensor_mechanics/test/tests/0_Cylinder/Cylinder_HF1_R5.csv'
        with open(path1) as csvfile:
            readCSV = csv.reader(csvfile, delimiter=',')
            Samp0 = []
            count = 0
    ...
    def LF1(self, E1, v1, ux, uy, uz):
        ...
        file1 = open('/home/dhullaks/projects/moose/modules/tensor_mechanics/test/tests/0_Cylinder/Cylinder_LF1_R5.i', 'r')
        Lines = file1.readlines()
        Lines[97] = "    "+"value = '"+str(ux)+"'\n"
        Lines[103] = "    "+"value = '"+str(uy)+"'\n"
        Lines[109] = "    "+"value = '"+str(uz)+"'\n"
        ...
        file1 = open('/home/dhullaks/projects/moose/modules/tensor_mechanics/test/tests/0_Cylinder/Cylinder_LF1_R5.i', 'w')
        file1.writelines(Lines)
        file1.close()

        os.chdir('/home/dhullaks/projects/moose/modules/tensor_mechanics/test/tests/0_Cylinder')
        os.system('/home/dhullaks/projects/moose/modules/tensor_mechanics/tensor_mechanics-opt -i Cylinder_LF1_R5.i')

        path1 = '/home/dhullaks/projects/moose/modules/tensor_mechanics/test/tests/0_Cylinder/Cylinder_LF1_R5.csv'
        with open(path1) as csvfile:
            readCSV = csv.reader(csvfile, delimiter=',')
            Samp0 = []
            count = 0
