...
counter = 1
file1 = open('/home/dhullaks/projects/Small_Pf_code/src/2D_TRISO_GP/Results_retrain.csv','w')
...
for ii in np.arange(0,Nsub,1):
    ...
    if u_check > u_lim:
        ...
        subs_info[ii,0] = 1.0
    file1 = open('/home/dhullaks/projects/Small_Pf_code/src/2D_TRISO_GP/Results_retrain.csv','r')
...
filename = 'Alg_Run_retrain_2000.pickle'
