...
amp0, len0 = ML0.GP_train_kernel(num_iters = 1000, amp_init = 1., len_init = np.array([1.,1.,1.,1.,1.,1.,1.,1.])) #
...
amp1, len1 = ML.GP_train_kernel(num_iters = 1000, amp_init = 1., len_init = np.array([1.,1.,1.,1.,1.,1.,1.,1.])) #
