...
class TrisoModel:
    ...
    def Triso_1d(self, kr, bt, it, st, ot, id, od, ib, ob, q1, q2, q3): #
        ...
        file1 = open('/Users/dhulls/projects/bison/examples/TRISO/Paper/Alg/Compact_3/1d_MC.i', 'r')
        Lines = file1.readlines()
        Lines[7] = "    "+"mean = '"+str(kr)+"'\n"
        Lines[14] = "    "+"mean = '"+str(bt)+"'\n"
        Lines[21] = "    "+"mean = '"+str(it)+"'\n"
        ...
        Lines[74] = "    "+"mean = '"+str(q3)+"'\n"
        Lines[80] = "    "+"mean = '"+str(q3)+"'\n"
        Lines[86] = "    "+"mean = '"+str(q3)+"'\n"

        file1 = open('/Users/dhulls/projects/bison/examples/TRISO/Paper/Alg/Compact_3/1d_MC.i', 'w')
        file1.writelines(Lines)
        file1.close()

        os.chdir('/Users/dhulls/projects/bison/examples/TRISO/Paper/Alg/Compact_3/')
        os.system('/Users/dhulls/projects/bison/bison-opt -i 1d_MC.i') # mpiexec -n 3

        path1 = '/Users/dhulls/projects/bison/examples/TRISO/Paper/Alg/Compact_3/1d_MC_out_sic_stress_return_0001.csv'
        with open(path1) as csvfile:
            readCSV = csv.reader(csvfile, delimiter=',')
            Samp0 = []
            count = 0
