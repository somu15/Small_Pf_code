...
counter = 1
file1 = open('/home/dhullaks/projects/Small_Pf_code/src/1D_TRISO_GP_DNN/Results.csv','w')
...
for ii in np.arange(0,Nsub,1):
    ...
    if u_check > u_lim:
        ...
        # DNN_model = ML0.DNN_train(dim=Ndim, seed=100, neurons1=6, neurons2=4, learning_rate=0.005, epochs=5000)
        subs_info[ii,0] = 1.0
    file1 = open('/home/dhullaks/projects/Small_Pf_code/src/1D_TRISO_GP_DNN/Results.csv','r')
