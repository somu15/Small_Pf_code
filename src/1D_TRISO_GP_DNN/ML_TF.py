...
class ML_TF:
    ...
    def DNN_train(self, ref_ind=None, dim=None, seed=None, neurons1=None, neurons2=None, learning_rate=None, epochs=None):
        ...
        normed_obs_ind = Norm1(self.obs_ind, ref_ind, dim)
        normed_obs = Norm3(self.obs.reshape(len(self.obs),1))
    ...
    def DNN_pred(self, ref_ind=None, model=None, dim=None, pred_ind=None):
        ...
        normed_pred_ind = Norm1(pred_ind, ref_ind, dim)
