...
class FluidModel:
    ...
    def Navier_Stokes(self, viscosity, density, u_Bottom, u_Top, u_Left, u_Right):
        ...
        file1 = open('/home/dhullaks/projects/moose/modules/navier_stokes/test/tests/ins/2d_steady/NS3.i', 'r')
        ...
        file1 = open('/home/dhullaks/projects/moose/modules/navier_stokes/test/tests/ins/2d_steady/NS3.i', 'w')
        file1.writelines(Lines)
        file1.close()

        os.chdir('/home/dhullaks/projects/moose/modules/navier_stokes/test/tests/ins/2d_steady')
        os.system('mpiexec -n 2 /home/dhullaks/projects/moose/modules/navier_stokes/navier_stokes-opt -i NS3.i')

        path1 = '/home/dhullaks/projects/moose/modules/navier_stokes/test/tests/ins/2d_steady/NS3.csv'
